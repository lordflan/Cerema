...
<body>
	<div class='container-fluid m-0 p-0'>
		...
		<div id='page'>
            ...
            <tbody>            
        <?php
        $resultat = $base->query('SELECT * FROM fiches');       
        while ($row=$resultat -> fetch()){
            echo "<tr>";
            echo "<td>".$row['id_fiche']."</td>";
            echo "<td>".$row['statut_fiche']."</td>";
            echo "<td>".$row['nom_fiche']."</td>";
            echo "<td>".$row['prenom_fiche']."</td>";
            echo "<td>".$row['arrivee_fiche']."</td>";
            echo "<td>".$row['poste_fiche']."</td>";
            echo "<td>".$row['creation_fiche']."</td>";
            echo "<td>".$row['etat_fiche']."</td>";
            echo "<td>".$row['batiment_fiche']."</td>";
            echo "<td>".$row['unite_fiche']."</td>";
            echo "<td>".$row['visa_fiche']."</td>";
            echo "<td>".$row['assistante_fiche']."</td>";
            echo "<td>".$row['telephonefixe_fiche']."</td>";
            echo "<td>".$row['limite_fiche']."</td>";
        ...
        <a href='base.php' class='btn btn-outline-primary'>Retour</a>
        </div>
	<!-- JS -->
