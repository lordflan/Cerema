...
echo("<html lang='fr'>
  ...
  <div class='col'>
  <a class='nav-link dropdown-toggle' data-toggle='dropdown' href='logout.php' role='button' aria-haspopup='true' aria-expanded='false'>");echo("<img class='lock' src='./lock.svg' alt='lock'> " . $_SESSION['login_utilisateur'] . " - " . $_SESSION['libellecourt_service'] . "_" . $_SESSION['libelle_role'] . "</a>");echo("
  <div class='dropdown-menu ml-5'>
...
echo("<footer class='row justify-content-center m-0 mb-4 mt-4'>
