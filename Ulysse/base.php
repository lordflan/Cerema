...
<body>
	<div class='container-fluid m-0 p-0'>
		<nav class='navbar navbar row m-0' style='background-color: #bcd4e6; border-bottom: 1px solid #000; border-top: 1px solid #000'>
			...
			<div class='col'>
				<a class='nav-link dropdown-toggle' data-toggle='dropdown' href='logout.php' role='button' aria-haspopup='true' aria-expanded='false'><?php echo("<img class='lock' src='./lock.svg' alt='lock'>&#9889; " .  $_SESSION['libelle_role'] . " &#9889;"); ?></a>
				<div class='dropdown-menu ml-5'>
		...
		<div id='page'>
			<div class='row justify-content-center m-0 pt-4 pb-4'>
				<h2>Choisir une table dans la base de données</h2>
			</div>			
			<div class='row justify-content-center m-0 pb-4 pt-5 '>
				<div class='col-2' style='text-align: center'>
					<a href="table_utilisateur.php"><img src='bdd.svg' alt='table1'></a>
					<h5>Table utilisateurs</h5>
				</div>
				<div class='col-2' style='text-align: center'>
					<a href="table_fiches.php"><img src='bdd.svg' alt='table2'></a>
					<h5>Table fiches</h5>
				</div>
				<div class='col-2' style='text-align: center'>
					<a href="table_besoin.php"><img src='bdd.svg' alt='table3'></a>
					<h5>Table besoins</h5>
				</div>
				<div class='col-2' style='text-align: center'>
					<a href="table_famille.php"><img src='bdd.svg' alt='table4'></a>
					<h5>Table famille</h5>
				</div>
				<div class='col-2' style='text-align: center'>
					<a href="table_service.php"><img src='bdd.svg' alt='table5'></a>
					<h5>Table services</h5>
				</div>
				<div class='col-2' style='text-align: center'>
					<a href="table_roles.php"><img src='bdd.svg' alt='table6'></a>
					<h5>Table rôles</h5>
				</div>
			</div>
		<div class='row justify-content-start m-0 pt-5 pl-3'>
				<div id='faq'>
					<img src='./alert.svg' alt='info'>
					<p style='text-align: center'>Administrateur</p>
					<p>Vous êtes FULL POWER dans cette interface.</p>
					<p>Vous pouvez faire tous les tests nécessaires,<br>
					mais également accéder aux tables de la base de données.</p>
					<p>Droits pour créer, lire, mettre a jour et même supprimer.</p>					
