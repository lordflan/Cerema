	...
	<div class='container-fluid m-0 p-0'>
		...
		<div id='page'>
            ...
            <thead class="thead-dark">
                <tr>
                <th scope="col">ID</th>
                <th scope="col">Libelle du besoin</th>
                <th scope="col">ID du rôle</th>
                <th scope="col">ID de la famille</th>
                </tr>
            </thead>
            <tbody>            
        <?php
        $resultat = $base->query('SELECT * FROM besoins');       
        while ($row=$resultat -> fetch()){
            echo "<tr>";
            echo "<td>".$row['id_besoin']."</td>";
            echo "<td>".$row['libelle_besoin']."</td>";
